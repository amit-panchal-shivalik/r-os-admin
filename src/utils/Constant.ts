...
const offerLandOptions = [
    ...
    { value: 'Plottings - Village Farm Land Type', label: 'Plottings - Village Farm Land Type' },
...
const PAGE_SIZES = Array.from({ length: Math.floor(500 / 12) }, (_, i) => (i + 1) * 12);

export {
    userData, landData, locations, summaryData, inquiryData,
    leadVerificationData, leadSourceData, addLandSourceData, showMessage, categoryOfVisitorOptions, offerLandOptions, campaignLeadTypeOptions,
    campaignTypeOptions, crmTypeOptions, statusOptions, leadTypeOptions, zoneOptions, documentFields, userTypeOptions, landTypeOptions, landUnitOptions,
    proposalOptions, projectTypeOptions, availableUnitTypes, projectForOptions, projectStatusOptions, nearByConnectivity, amenitiesOptions, sustainableGreenFeatures,
    paymentPlanTypeOptions, bankOptions, visibilityOptions, structuralTypeOptions, projectPartnerOptions, floorOptions, MASTER_CONFIG, typeOptions, PAGE_SIZES
};
