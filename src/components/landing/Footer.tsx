                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    <div>
                        ...
                        <p className="text-gray-600 text-sm">
                            Your trusted platform for finding and connecting with the best residential communities.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            <li>
                                <a href="#communities" className="text-gray-600 hover:text-black text-sm">
                                    Communities
                                </a>
                            </li>
                            <li>
                                <a href="#events" className="text-gray-600 hover:text-black text-sm">
                                    Events
                                </a>
                            </li>
                            <li>
                                <a href="#amenities" className="text-gray-600 hover:text-black text-sm">
                                    Amenities
                                </a>
                            </li>
                        </ul>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            <li>
                                <a href="#help" className="text-gray-600 hover:text-black text-sm">
                                    Help Center
                                </a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="#faq" className="text-gray-600 hover:text-black text-sm">
                                    FAQ
                                </a>
                            </li>
                        </ul>
