                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            <li>
                                <a href="#communities" className="text-gray-400 hover:text-white text-sm">
                                    Communities
                                </a>
                            </li>
                            <li>
                                <a href="#events" className="text-gray-400 hover:text-white text-sm">
                                    Events
                                </a>
                            </li>
                            <li>
                                <a href="#amenities" className="text-gray-400 hover:text-white text-sm">
                                    Amenities
                                </a>
                            </li>
                        </ul>
