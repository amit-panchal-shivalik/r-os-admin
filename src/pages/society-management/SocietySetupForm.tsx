...
import TextareInput from '../../components/CustomInput/TextareInput';
              ...
              <Form>
                <Tabs value={activeTab} onValueChange={setActiveTab}>
                  ...
                  <TabsContent value="basic" className="space-y-6">
                    <h2 className="text-2xl font-bold text-design-primary mb-4">Basic Information</h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div>
                        ...
                        <Field
                          ...
                          className={`standard-input ${errors.societyName && touched.societyName ? 'error' : ''}`}
                        />
                        <ErrorMessage name="societyName" component="div" className="error-message" />
                      </div>

                      {/* Society Code */}
                      <div>
                        <label htmlFor="societyCode" className="block text-sm font-semibold text-design-primary mb-2">
                        ...
                        <div className="flex items-center gap-2">
                          <Field
                            ...
                            readOnly
                            className="flex-1 px-4 py-3 border rounded-lg bg-design-description text-design-primary focus:outline-none focus:ring-2 focus:ring-design-primary"
                          />
                          <Button
                            type="button"
                    ...
                    <div>
                      ...
                      <Field
                        ...
                        className={`standard-input resize-y min-h-[2.5rem] ${errors.description && touched.description ? 'error' : ''}`}
                      />
                  ...
                  <TabsContent value="project" className="space-y-6">
                    <h2 className="text-2xl font-bold text-design-primary mb-4">Project Details</h2>
                  ...
                  <TabsContent value="contact" className="space-y-6">
                    <h2 className="text-2xl font-bold text-design-primary mb-4">Contact Information</h2>
                  ...
                  <TabsContent value="legal" className="space-y-6">
                    <h2 className="text-2xl font-bold text-design-primary mb-4">Legal Documents</h2>
                  ...
                  <TabsContent value="financial" className="space-y-6">
                    <h2 className="text-2xl font-bold text-design-primary mb-4">Financial Setup</h2>
                  ...
                  <TabsContent value="settings" className="space-y-6">
                    <h2 className="text-2xl font-bold text-design-primary mb-4">Additional Settings</h2>
