...
const MODULE_SYNONYMS: Record<string, string> = {
  ...
  reinforcementcuttingmachinechecklist: 'ReinforcementCuttingChecklist',
  reinforcementcuttingchecklist: 'ReinforcementCuttingChecklist',
  reinforcementbendingmachinechecklist: 'ReinforcementBendingChecklist',
  reinforcementbendingchecklist: 'ReinforcementBendingChecklist',
  dailyobservationsheet: 'DailyObservation',
  dailyobservation: 'DailyObservation',
  pperegister: 'PPERegister',
  truckinspectionchecklist: 'TruckInspection',
  truckinspection: 'TruckInspection',
  safetyStatisticsBoard: 'SafetyStatisticsBoard',
  safetystatisticsboard: 'SafetyStatisticsBoard',
  ehsstatisticsboard: 'SafetyStatisticsBoard',
  accidentinvestigationreport: 'AccidentInvestigationReport',
  accidentinvestigation: 'AccidentInvestigationReport',
  portableequipmentinspection: 'PortableEquipmentInspection',
  portableelectricalequipmentregister: 'PortableEquipmentInspection',
  portableequipmentregister: 'PortableEquipmentInspection',
